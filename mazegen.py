...
class maze:
    ...
    def CreateMaze(self, x: object = 1, y: object = 1, pattern: object = None, loopPercent: object = 0, saveMaze: object = False, loadMaze: object = None,
                   theme: COLOR = COLOR.dark) -> object:
        '''
